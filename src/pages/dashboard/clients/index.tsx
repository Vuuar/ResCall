...
export default function Clients() {
  ...
  return (
    <DashboardLayout user={user} title="Clients - WhatsApp Booking">
      <div className="py-6">
          ...
          <div className="py-4">
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-lg font-medium text-secondary-900">Vos clients</h2>
                <button
                  type="button"
              ...
              <div className="border-t border-secondary-200 pt-4">
                <div className="text-center py-12">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-secondary-900">Aucun client</h3>
